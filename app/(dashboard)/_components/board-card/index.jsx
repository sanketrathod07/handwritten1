...
export const BoardCard = ({
    ...
    return (
        <Link href={`/board/${id}`}>
            <div className="group aspect-[100/127] border rounded-lg flex flex-col justify-between overflow-hidden md:w-48 h-60">
                <div className="relative flex-1 bg-[#d0daff]">
                    <Image
                        src={imageUrl}
                        alt={title}
                        fill
